 ...
 * @author aluno
 */
public class AddProfView extends javax.swing.JDialog {

    
    ArrayList<Pessoa> listaProf = new ArrayList<>();//Cria uma lista para preencher com a busca
    /**
     * Creates new form PagamentoView
     */
    public AddProfView(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        jInserirPagamento.setText("Inserir Professor");
        ...
        jLabel7.setText("Digite o registro do professor:");

        jLabel5.setForeground(new java.awt.Color(153, 153, 153));
        jLabel5.setText("*Somente 5 caracteres");
        ...
        jRegistrarLayout.setHorizontalGroup(
            ...
            .addGroup(jRegistrarLayout.createSequentialGroup()
                .addContainerGap()
                .addGroup(jRegistrarLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addComponent(jInserirPagamento, javax.swing.GroupLayout.DEFAULT_SIZE, 266, Short.MAX_VALUE)
        ...
        jLabel6.setText("Registrar Professor");
        jLabel6.setAlignmentX(0.5F);
        jLabel6.setMaximumSize(new java.awt.Dimension(121, 50));

        jLabel8.setForeground(new java.awt.Color(153, 153, 153));
        jLabel8.setText("*Ao escolher na caixa acima, atualize a tela");
                ...
                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addGroup(layout.createSequentialGroup()
                        ...
                        .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            ...
                            .addGroup(layout.createSequentialGroup()
                                .addComponent(jAlunos, javax.swing.GroupLayout.PREFERRED_SIZE, 177, javax.swing.GroupLayout.PREFERRED_SIZE)
                                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                                .addComponent(jAtualizar, javax.swing.GroupLayout.PREFERRED_SIZE, 79, javax.swing.GroupLayout.PREFERRED_SIZE))))
                    .addGroup(layout.createSequentialGroup()
                        .addGap(26, 26, 26)
                        .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            .addComponent(jRegistrar, javax.swing.GroupLayout.PREFERRED_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.PREFERRED_SIZE)
        ...
        layout.setVerticalGroup(
            ...
            .addGroup(layout.createSequentialGroup()
                ...
                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
                    .addComponent(jAlunos, javax.swing.GroupLayout.PREFERRED_SIZE, 23, javax.swing.GroupLayout.PREFERRED_SIZE)
                    .addComponent(jAtualizar, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE))
                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.UNRELATED)
                .addComponent(jLabel8)
                .addGap(28, 28, 28)
                .addComponent(jRegistrar, javax.swing.GroupLayout.PREFERRED_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.PREFERRED_SIZE)
    ...
    private void jPesquisarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jPesquisarActionPerformed
        try {
            ...
            Pessoa pessoaPesq;
            pessoaPesq = new Pessoa(jLogin.getText(), "", jNome.getText(), jCPF.getText(), "Professor");             
            
            //Cria o dao usu para fazer a busca
            usuarioDAO dao = new usuarioDAO();
            profDAO daoProf = new profDAO();
            
            //Se o usuario NÃO está registrado
            if(daoProf.getByLoginSenha(new Professor(pessoaPesq, null)) == null) {
                //preenche a lista com o resultado dos professores
                listaProf = dao.procurar(pessoaPesq);                
                ...
                cbModel.addElement("Escolha um Professor");

                //cria um foreach para cada aluno na lista
                for (Pessoa pessAdd:listaProf) { 
                    //adiciona cada pessoa na combo box
                    cbModel.addElement(pessAdd.getNome()+". CPF: "+ pessAdd.getCpf());
                } 
            } else {
                JOptionPane.showMessageDialog(this, "Nenhum professor que ainda não foi registrado encontrado!\nCrie um login de professor!");
            }           
    ...
    private void jInserirPagamentoActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jInserirPagamentoActionPerformed
        try {                        
            //Cria um professor passando a pessoa selecionada
            Professor prof = new Professor(listaProf.get(jAlunos.getSelectedIndex()-1), jRegistro.getText());

            //Cria a dao aluno para ser usada
            profDAO daoProf = new profDAO();

            //Se já existir um professor na tabela professor
            ...
            if(daoProf.getByLoginSenha(prof)!=null){
                ...
                //Pega o professor atualizado
                prof = daoProf.getByLoginSenha(prof);
            }

            JOptionPane.showMessageDialog(this, "O registro de "+prof.getNome()+" é: "+prof.getRegistro());
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(AddProfView.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                AddProfView dialog = new AddProfView(new javax.swing.JFrame(), true);
